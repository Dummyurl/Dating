...
public interface Constants {
    ...
    public static final String WEB_SITE = "http://dater.blackd.ir/";  //web site url address
    ...
    public static final String BILLING_KEY = "MIIBIjANBgkqhkiG9w0BAQEFAAOCAQ8AYfydPhh4FWUmr2bljwc7KMFU5eTWpikBWCOCsvg6WHmmXZU1/u6fg6";
    ...
    public static final String API_DOMAIN = "http://dater.blackd.ir/";  //url address to which the application sends requests
